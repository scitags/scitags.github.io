...
```
In all the following examples scitag is an integer calculated using the following formula: 
<expID><<6|<actID> where expID and actID are relevant IDs from registry
```
